...
var quizObj = {"time": 0,"tchr":"","clss":"", "frag": "","data":{"info":{"name":"Collocations Quiz","main":"","results":"","level1":"well done! You know your collocations!","level2":"you know a lot about collocations!","level3":"you have some knowledge of collocations. Keep studying!","level4":"practice more collocations!","level5":"please practice more!"},"questions":[]}};
...
function convertObj(el) {
   var qObj = {};
    ...
    qObj.a = [
        {
            "option": "" + el.col.dis1 + " | " +  el.col.dis2 + " | " +  el.col.dis3,
            "imc": false
        },{
            "option": "" + el.col.ans2 + " | " +  el.col.dis3 + " | " +  el.col.dis1,
            "imc": false
        },{
            "option": "" + el.col.dis2 + " | " +  el.col.ans3 + " | " +  el.col.ans1,
            "imc":false
        },{
            "option": "" + el.col.ans1 + " | " +  el.col.ans2 + " | " +  el.col.ans3,
            "imc":true
        }
    ];
