/*global jQuery*/
/* SlickQuiz jQuery Plugin * http://github.com/jewlofthelotus/SlickQuiz * @version 1.5.20 * @author Julie Cameron * @license MIT */
...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                json: {"info":{"name":"No vocabulary available.","main":"","results":"","level1":"well done!","level2":"you know a lot!","level3":"you have some knowledge. Keep studying!","level4":"practice more!","level5":"please practice more!"},"questions":[]},
                nameOfThisQuiz: 'default',
                checkAnswerText:  'Check answer',
                nextQuestionText: 'Next &raquo;',
                backButtonText: '&laquo; Back',
                completeQuizText: 'View results',
            ...
            correctResponseClass   = 'imc',
            incorrectResponseClass = 'inc',
        ...
        var quizValues = (plugin.config.json ? plugin.config.json : null);
        ...
        plugin.method = {
            setupQuiz: function(options) {
                ...
                if (plugin.config.tryAgainText && plugin.config.tryAgainText !== '') {
                    $quizResultsCopy.append('<p><a class="btn btn-primary btn-sm ' + tryAgainClass + '" href="#">' + plugin.config.tryAgainText + '</a></p>');
                }
                ...
                for (var i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        for (var ii in answers) {
                            if (answers.hasOwnProperty(ii)) {
                                answer = answers[ii];
                                var optionId = inputName + '_' + ii.toString();
                                var input = '<input id="' + optionId + '" name="' + inputName +
                                            '" type="' + inputType + '" /> ';
                                var optionLabel = '<label for="' + optionId + '">' + answer.option + '</label>';
                                var answerContent = $('<li class="radio"></li>')
                                    .append(input)
                                    .append(optionLabel);
                        ...
                        if (plugin.config.perQuestionResponseMessaging || plugin.config.completionResponseMessaging) {
                            ...
                            responseHTML.append('<li class="' + correctResponseClass + '">' + question.imc + '</li>');
                            responseHTML.append('<li class="' + incorrectResponseClass + '">' + question.inc + '</li>');
                            questionHTML.append(responseHTML);
                        }
                        if (plugin.config.backButtonText && plugin.config.backButtonText !== '') {
                            questionHTML.append('<a href="#" class="btn btn-info btn-sm ' + backToQuestionClass + '">' + plugin.config.backButtonText + '</a>');
                        }
                        ...
                        if (!plugin.config.perQuestionResponseMessaging) {
                            questionHTML.append('<a href="#" class="btn btn-primary btn-sm ' + nextQuestionClass + ' ' + checkAnswerClass + '">' + nextText + '</a>');
                        } else {
                            questionHTML.append('<a href="#" class="btn btn-primary btn-sm ' + nextQuestionClass + '">' + nextText + '</a>');
                            questionHTML.append('<a href="#" class="btn btn-info btn-sm ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a>');
                        }
